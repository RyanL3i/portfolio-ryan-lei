...
const Welcome = () => {
    ...
    return (
        <div id="Home" className="lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center">
                ...
                <div data-aos="fade-left" className="flex mt-8 gap-2">
                    <div className="flex items-center justify-center">
                        <div className="flex space-x-2">
                            ...
                            <a href="https://www.linkedin.com/in/ryan-leii/" target="_blank" className="text-teal-300 rounded-full glow p-2">
            ...
            <div>
                {/*<Gallery/>*/}
                <img data-aos="fade-up" src={sidePiano} width={350} height={350} className="max-w-[1000px] h-auto rounded-3xl border-2 border-teal-300 img_glow" alt="Display Photo: Me playing piano" />
            </div>
        </div>
    )
}
