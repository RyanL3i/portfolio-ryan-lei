...
const AboutMe = () => {
  return (
    <div id="About" className="mb-24 lg:mb-40 mt-20 lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center">
      <img data-aos="fade-down" src={hawaiiFlex} width={350} height={350} className="border-2 border-teal-300 img_glow rounded-3xl" alt="Hawaii Flex" />
        ...
        <div data-aos="fade-right" className="flex mt-8 gap-2">
          <div className="flex items-center justify-center">
            <div className="flex space-x-8">
              <a href="https://firebasestorage.googleapis.com/v0/b/resume-4aaff.appspot.com/o/Ryan_Lei__Resume.pdf?alt=media&token=95697a95-44a5-4bbf-8f3d-a312a0de90b8" target="_blank">
