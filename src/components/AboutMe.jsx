...
const AboutMe = () => {
  return (
    <div id="About" className="mb-24 lg:mb-40 mt-20 lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center">
      <img data-aos="fade-down" src={hawaiiFlex} width={350} height={350} className="rounded-3xl border-2 border-teal-300 img_glow" alt="Display Photo: Me playing piano" />
      <div className="h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white">
        ...
        <p data-aos="fade-right">Besides academics, I love to travel, with Hawaii and Europe are 2 of my favorite destinations. Throughout my life,
          I have found it important to emphasize my love of music and fitness through piano performance and bodybuilding.
          I am also a huge movie/television fan, and am always willing to have a chat about anything!
        </p>
